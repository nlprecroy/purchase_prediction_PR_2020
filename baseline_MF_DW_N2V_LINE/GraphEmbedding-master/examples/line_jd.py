...
if __name__ == "__main__":
    ...
    model = LINE(G, embedding_size=100, order='all')
    model.train(batch_size=1024, epochs=6, verbose=2)
    embeddings = model.get_embeddings()
    print(len(embeddings))
    with open("pretrained_all_line_real_floatloss_sigmoid.pkl", "wb") as writer:
